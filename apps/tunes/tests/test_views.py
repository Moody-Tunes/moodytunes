...
class TestLastPlaylistView(APITestCase):
    @classmethod
    def setUpTestData(cls):
...
class TestVoteView(APITestCase):
    ...
    def test_submitting_duplicate_votes_with_different_context_is_allowed(self):
        ...
        resp = self.client.post(self.url, data=new_data, format='json')
    ...
    def test_delete_happy_path(self):
        ...
        resp = self.client.delete(self.url, data=data, format='json')
...
class TestOptionsView(APITestCase):
    @classmethod
    def setUpTestData(cls):
...
class TestVoteInfoView(APITestCase):
    @classmethod
    def setUpTestData(cls):
