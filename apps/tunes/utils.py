...
def generate_browse_playlist(lower_bound, upper_bound, exclude_ids, limit=None, jitter=None):
    """
    ...
    :@ param exclude_ids: (list[int]) List of `Song` ids to exclude from the playlist
